	...
	public class SeatsService : ISeatsService
	{
		...
		public async Task<ReservationResponse> ReserveSeats(int showtimeId, List<SeatEntity> desiredSeats)
		{
			...
			try
			{
				...
				if (showtime == null || !showtime.Any()) throw new InvalidOperationException(ErrorMessages.SeatsService.ShowtimeNotFound);
			...
			catch (DbUpdateConcurrencyException)
			{
				...
				throw new InvalidOperationException(ErrorMessages.SeatsService.ConcurrencyConflictError);
			}
		...
		public async Task BuySeat(Guid reservationGuid)
		{
			...
			try
			{
				...
				if (ticket == null)
				{
					throw new InvalidOperationException(ErrorMessages.SeatsService.InvalidReservation);
				}
